...
<body>
    ...
    <main>
        <h1>Relatórios da Equipa</h1>
        <?php if ($equipa): ?>
            <h2><?php echo htmlspecialchars($equipa['nome']); ?></h2>
            <!-- Aqui pode adicionar gráficos, KPIs, etc. -->
            <p>Relatórios e indicadores da equipa <?php echo htmlspecialchars($equipa['nome']); ?>.</p>
        <?php else: ?>
            <p>Selecione uma equipa para ver os relatórios.</p>
        <?php endif; ?>
    </main>
